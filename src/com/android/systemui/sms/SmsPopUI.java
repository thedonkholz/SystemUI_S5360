...
public class SmsPopUI extends SystemUI {
	...
	if (intent != null) {
	       ...
	       StringBuilder body = new StringBuilder(); // sms content
            ...
            if (Settings.System.getInt(mResolver, "use_popup_sms", 1) == 1) {
    ...
    private void showSmsInfo() {
        ...
        View v = (View) mInflater.inflate(SmsHelper.getSmsPopupLayout(mContext,"smscall_widget") , null);

        mContactPicture = (ImageView) v.findViewById(SmsHelper.getSmsPopupId(mContext, "contactpicture"));
        mContactName = (TextView) v.findViewById(SmsHelper.getSmsPopupId(mContext, "contactname"));
        mSmsBody = (TextView) v.findViewById(SmsHelper.getSmsPopupId(mContext, "smsmessage"));
        mTimeStamp = (TextView) v.findViewById(SmsHelper.getSmsPopupId(mContext, "smstime"));
        mCallsButton = (Button) v.findViewById(SmsHelper.getSmsPopupId(mContext, "calls_button"));
