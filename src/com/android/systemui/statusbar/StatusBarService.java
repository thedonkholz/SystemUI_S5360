...
public class StatusBarService extends Service implements CommandQueue.Callbacks {
    ...
    private class ExpandedDialog extends Dialog {
        ...
        public boolean dispatchKeyEvent(KeyEvent event) {
            ...
            if (mFocusBlocked || mExpandedView.getDescendantFocusability() == 393216) {
                mFocusBlocked = false;
                mExpandedView.setDescendantFocusability(262144);
                mExpandedView.requestFocus();
            }
    ...
    private void makeStatusBarView(Context context) {
        ...
        mExpandedView.addView((QuickSettingsView) View.inflate(context, R.layout.quickpanel_quick_settings, null), 0);
        mMiniCon = new LinearLayout(context);
        mMiniCon.setOrientation(LinearLayout.VERTICAL);
		((LinearLayout)mExpandedView.findViewById(R.id.notificationLinearLayout)).addView(mMiniCon, 0);
    ...
    private int chooseIconIndex(boolean isMiniCon, boolean isOngoing, int viewIndex) {
        int latestSize = mLatest.size();
        int ongoingSize = mOngoing.size();
    ...
    StatusBarIconView addNotificationViews(IBinder key, StatusBarNotification notification) {
        ...
        LinearLayout parent;
        final boolean isMiniCon = notification.isMiniCon();
        if (isMiniCon) {
            list = mMiniConData;
            parent = mMiniCon;
        } else if (isOngoing) {
        ...
        // Add the icon.
        final int iconIndex = chooseIconIndex(isMiniCon, isOngoing, viewIndex);
