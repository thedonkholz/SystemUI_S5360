 ...
 * minutes.
 */
public class RightClock extends TextView {
    ...
    private boolean mShowRightClock;
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
												 "status_bar_am_pm"), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
												 "status_bar_clock"), false, this);
            resolver.registerContentObserver(Settings.System.getUriFor(
												 "status_bar_weekday"), false, this);
        }
    ...
    public RightClock(Context context) {
        this(context, null);
    }

    public RightClock(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RightClock(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void updateSettings(){
        ...
        mShowRightClock = (Settings.System.getInt(resolver,
											 "status_bar_clock", 1) == 1);
