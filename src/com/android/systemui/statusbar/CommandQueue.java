...
class CommandQueue extends IStatusBar.Stub {
    ...
    private static final int MSG_SHOW_CALL = 0x00070000;

    private static final int MSG_HIDE_CALL = 0x00080000;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (what) {
                ...
                case MSG_SET_VISIBILITY:
                    ...
                    break;
                case MSG_SHOW_CALL:
                    mCallbacks.showCallOnGoingView();
                    break;
                case MSG_HIDE_CALL:
                    mCallbacks.hideCallOnGoingView();
            }
        }
    }
	...
	public void showCallOnGoingView() {
        synchronized (mList) {
            mHandler.obtainMessage(MSG_SHOW_CALL).sendToTarget();
        }
	}

	public void hideCallOnGoingView() {
        synchronized (mList) {
            mHandler.obtainMessage(MSG_HIDE_CALL).sendToTarget();
        }
	}
}
