...
public class StatusBarIconView extends AnimatedImageView {
    ...
    public boolean set(StatusBarIcon icon) {
        ...
        if (!iconEquals) {
            ...
            if (drawable == null) {
                Slog.w("StatusBarService", "No icon for slot " + mSlot);
                return false;
            }
    ...
    public static Drawable getIcon(Context context, StatusBarIcon icon) {
        ...
        if (icon.iconPackage != null) {
            try {
                ...
                Slog.e("StatusBarService", "Icon package not found: " + icon.iconPackage);
                return null;
            }
        } else {
        ...
        try {
            ...
            StrB = new StringBuilder("Icon not found in");
			if (icon.iconPackage == null) {}
		}
		for (Object Obj = Integer.valueOf(iconId);; Obj = "<system>")
		{
			Slog.w("StatusBarService", Obj + ": " + Integer.toHexString(iconId));
			return null;
		}
	}
